...
*/
def groups = "yes"
/*=== Disable Group Functions ========================================
If you are not using Group functions, you can remove the tiles from
the display by removing the "//" from the line below.				*/
...
01-19		Fixed error causing UPnP play not to work at times.
		...
		updated.
03-28		a.	Fixed repeat and shuffle values to match method
			return.
		b.	Added playText functions.
		c.	(Speakers Only) Added voices to playText.
		d.	(Soundbars Only) Changed TTS engine to work
			around Amazon Poly access problem from
			soundbars.
		e.	Added Data Formats Comment Section to identify
			explicit formats on custom commands and
			attributes
...
//	Add attribute state "stopped" to the states?
...
preferences {
	...
	def ttsVoices = ["Naja":"Danish - Female","Mads":"Danish - Male","Lotte":"Dutch - Female",
		"Ruben":"Dutch - Male","Nicole":"English (Australian) - Female",
		"Russell":"English (Australian) - Male","Amy":"English (British) - Female",
		"Emma":"English (British) - Female","Brian":"English (British) - Male",
		"Aditi":"English (Indian) - Female","Raveena":"English (Indian) - Female",
		"Ivy":"English (US) - Female","Joanna":"English (US) - Female",
		"Kendra":"English (US) - Female","Kimberly":"English (US) - Female",
		"Salli":"English (US) - Female","Joey":"English (US) - Male",
		"Justin":"English (US) - Male","Matthew":"English (US) - Male",
		"Geraint":"English (Welsh) - Male","Celine":"French - Female",
		"Mathieu":"French - Male","Chantal":"French (Canadian) - Female",
		"Marlene":"German - Female","Vicki":"German - Female","Hans":"German - Male",
		"Dora":"Icelandic - Female","Karl":"Icelandic - Male","Carla":"Italian - Female",
		"Giorgio":"Italian - Male","Mizuki":"Japanese - Female","Takumi":"Japanese - Male",
		"Seoyeon":"Korean - Female","Liv":"Norwegian - Female","Ewa":"Polish - Female",
		"Maja":"Polish - Female","Jacek":"Polish - Male","Jan":"Polish - Male",
		"Vitoria":"Portuguese (Brazilian) - Female","Ricardo":"Portuguese (Brazilian) - Male",
		"Ines":"Portuguese (European) - Female","Cristiano":"Portuguese (European) - Male",
		"Carmen":"Romanian - Female","Tatyana":"Russian - Female","Maxim":"Russian - Male",
		"Conchita":"Spanish (Castilian) - Female","Enrique":"Spanish (Castilian) - Male",
		"Penelope":"Spanish (Latin American) - Female",
		"Miguel":"Spanish (Latin American) - Male","Astrid":"Swedish - Female",
		"Filiz":"Turkish - Female","Gwyneth":"Welsh - Female"]
	...
	input name: "voice", type: "enum", title: "SPEAKER ONLY TTS Voice", 
		options: ttsVoices, description: "The Voice for the SPEAKER TTS", required: false

	input name: "ttsApiKey", type: "text", title: "SOUNDBAR ONLY Text-To-Speech Key", 
		description: "From http://www.voicerss.org/registration.aspx", required: false

	input name: "ttsLang", type: "enum", title: "SOUNDBAR ONLY TTS Language", 
		options: ttsLanguages, description: "The Language for SOUNDBAR TTS", required: false

	input name: "rearSpeaker", type: "enum", title: "Soundbar Rear Speaker???", 
		options: rearSpeakerYn, description: "Do you have the soundbar Rear Speakers", required: false

	input name: "rearLevel", type: "enum", title: "Rear Speaker Level", 
...
def playTrack(String uri, volume) {
	...
	log.error "${device.label}_playTrack: Not Supported."
}
