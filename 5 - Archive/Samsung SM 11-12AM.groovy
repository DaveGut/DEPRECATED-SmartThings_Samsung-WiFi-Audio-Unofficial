...
//	other subscriptions (for test purposes to see if we ever get ANY).
	subscribe(location, "ssdpTerm.urn:samsung.com:device:RemoteControlReceiver:1", subscribeHandler)
	subscribe(location, "ssdpTerm.urn:samsung.com:service:MultiScreenService:1", subscribeHandler)
	subscribe(location, "ssdpTerm.urn:dial-multiscreen-org:service:dial:1", subscribeHandler)
	subscribe(location, "ssdpTerm.urn:schemas-upnp-org:service:RenderingControl:1", subscribeHandler)
	subscribe(location, "ssdpTerm.urn:schemas-upnp-org:service:ConnectionManager:1", subscribeHandler)
	subscribe(location, "ssdpTerm.urn:schemas-upnp-org:service:AVTransport:1", subscribeHandler)
	subscribe(location, "ssdpTerm.urn:schemas-rvualliance-org:service:StreamSplicing:1", subscribeHandler)
}
...
//	----- CREATE NORMAL GROUP SUPPORT -----



//	----- CREATE SURROUND GROUP SUPPORT -----
